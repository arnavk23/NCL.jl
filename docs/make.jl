...
DocMeta.setdocmeta!(NCL, :DocTestSetup, :(using NCL); recursive = true)
...
makedocs(;
  ...
  repo = "https://github.com/JuliaSmoothOptimizers/NCL.jl/blob/{commit}{path}#{line}",
  sitename = "NCL.jl",
  format = Documenter.HTML(; canonical = "https://JuliaSmoothOptimizers.github.io/NCL.jl"),
  pages = list_pages(),
)

deploydocs(;
  repo = "github.com/JuliaSmoothOptimizers/NCL.jl",
  push_preview = true,
  devbranch = "main",
)
